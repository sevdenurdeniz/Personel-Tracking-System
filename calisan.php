...
<body>
    ...
    $calisanlar = $conn->prepare("SELECT * FROM empInfo2");
                ...
                <div class="col-12 mt-4">
                    <table class="table table-striped">
                        ...
                        foreach ($calisanlar as $calisan) {
                            $birthdate = $calisan["BirthDate"]; // Doğum tarihi
                            $age = date_diff(date_create($birthdate), date_create('today'))->y; // Yaş hesaplama
                            echo "<tr> <td>"
                                . $calisan["TCKN"]
                                . "</td>  <td>" .
                                $calisan["Name"]
