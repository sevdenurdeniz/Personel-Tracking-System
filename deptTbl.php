        ...
        <div class="container">
            <div class="row">
                <div class="col-12 my-3">
                    <h4>Departman Oluştur</h4>
                    <form id="yeniDept" action="deptEkle.php" method="POST">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="form-group mt-3">
                                    <label for="DeptInfo">DeptInfo</label>
                                    <input class="form-control" type="text" id="DeptInfo" name="DeptInfo">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="DeptManager">DeptManager</label>
                                    <input class="form-control" type="text" id="DeptManager" name="DeptManager">
                                </div>
                            </div>
